...
export default function Footer() {
  ...
  const contactInfo = [
    ...
    { icon: <Mail className="w-5 h-5" />, text: "xeritechi@gmail.com" },
  ];

  return (
    <footer className="p-4 bg-gradient-to-b from-green-800 to-green-900 text-white border-t-4 border-green-600">
      <div className="space-x-6 container mx-auto px-4 xl:px-0 py-12">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-200">
                  Dini Həyatınızın Rəhbəri
                </p>
              </div>
            </div>
            <p className="text-sm text-green-100 leading-relaxed">
              "Ey Rəbbim! Mənə bir az möhlət versəydin, sədəqə verib
              əməlisalehlərdən olardım!"
              <br />
              (Münafiqun, 10)
            </p>
          </div>
        ...
        <div className="border-t border-green-700 mt-8 pt-8 text-center">
          <div className="text-sm text-green-300">
            © {currentYear} Mescid.az - Bütün hüquqlar qorunur
            <br />
